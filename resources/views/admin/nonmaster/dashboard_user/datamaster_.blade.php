                                ...
                                <div class="nav-container">
                                    <ul class="nav nav-icons" role="tablist">
                                        ...
                                        @elseif($penyulang)
                                            ...
                                            <li class="">
                                                <a href="#code-fork-logo" role="tab" data-toggle="tab"
                                                   aria-expanded="false">
                                                    <i class="fa fa-code-fork"></i><br>List PCT
                                                </a>
                                            </li>
                                            <li class="">
                                                <a href="#industry-logo" role="tab" data-toggle="tab"
                                                   aria-expanded="false">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="card">
                                                            ...
                                                            <div class="content">
                                                                <form action="{{route('input_datamaster.store')}}"
                                                                      method="post">
                                                                        ...
                                                                        <div class="content">
                                                                            <form action="{{route('input_datamaster.store')}}"
                                                                                ...
                                                                                <input type="hidden" name="tipe"
                                                                                       value="GI">
                                                                                <input type="hidden" name="idgardu"
                                                                                       value={{$gi->id}}>
                                                                                <input type="hidden" name="form_gi"
                                                                                       value={{$gi->id}}>
                                                                                {{--{{dd($gardu)}}--}}
                                                                                {{ csrf_field() }}
                                                        ...
                                                        <div class="card">
                                                            <div class="header">
                                                                @if($gi)
                                                                    <h4 class="title">GARDU INDUK {{$gi->nama_gi}}</h4>
                                                                @elseif($trafo_gi)
                                                                    <h4 class="title">TRAFO
                                                                        GI {{$trafo_gi->nama_trafo_gi}}</h4>
                                                                @elseif($penyulang)
                                                                    <h4 class="title">
                                                                        PENYULANG {{$penyulang->nama_penyulang}}</h4>
                                                                @elseif($gardu)
                                                                    @if($gardu->tipe_gardu == 0)

                                                                        <h4 class="title">GARDU
                                                                            DISTRIBUSI {{$gardu->nama_gardu}}</h4>
                                                                    @elseif($gardu->tipe_gardu == 1)

                                                                        <h4 class="title">
                                                                            PCT {{$gardu->nama_gardu}}</h4>
                                                                    @elseif($gardu->tipe_gardu == 2)

                                                                        <h4 class="title">PELANGGAN
                                                                            TM {{$gardu->nama_gardu}}</h4>
                                                                    @endif
                                                                @endif
                                                                {{--<p class="category">Data KWH Meter</p>--}}
                                                            </div>
                                                                    ...
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-md-4">
                                                                            <div class="form-group">
                                                                                <label>Rayon</label>
                                                                                <input type="text" class="form-control"
                                                                                       disabled="" placeholder="Rayon"
                                                                                       value="{{$rayon->nama_organisasi}}">
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-md-4">
                                                                            <div class="form-group">
                                                                                ...
                                                                                @elseif($trafo_gi)
                                                                                    <input type="text"
                                                                                           ...
                                                                                           disabled=""
                                                                                           placeholder="Alamat"
                                                                                           value="{{$trafo_gi->alamat_trafo_gi}}">
                                                                                @elseif($penyulang)
                                                                                    <input type="text"
                                                                                           class="form-control"
                                                                                           disabled=""
                                                                                           placeholder="Alamat"
                                                                                           value="{{$penyulang->alamat_penyulang}}">
                                                                                @elseif($gardu)
                                                                                    <input type="text"
                                                                                           class="form-control"
                                                                                           disabled=""
                                                                                           placeholder="Alamat"
                                                                                           value="{{$gardu->alamat_gardu}}">
                                                                                @endif
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                    ...
                                                    <div class="card">
                                                        ...
                                                        <div class="content">
                                                            ...
                                                            <form action="{{route('input_datamaster.store')}}"
                                                                ...
                                                                <input type="hidden" name="idtrafo_gi"
                                                                       value={{$trafo_gi->id}}>
                                                                <input type="hidden" name="form_trafogi"
                                                                       value="{{$trafo_gi->id}}">
                                                                <input type="hidden" name="form_kapasitas"
                                                                       value="{{$trafo_gi->id}}">
                                                                {{ csrf_field() }}
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <div class="input-group">
                                                                                <input name="tegangan" type="text"
                                                                                       class="form-control"
                                                                                       placeholder="Tegangan"
                                                                                       value="{{$decoded['kapasitas']['tegangan']}}">
                                                                        ...
                                                                        <div class="form-group">
                                                                            ...
                                                                            <div class="input-group">
                                                                                <input name="kapasitas" type="text"
                                                                                       ...
                                                                                       value="{{$decoded['kapasitas']['kapasitas']}}">
                                                ...
                                                <div class="col-md-12">
                                                    <div class="nav-container">
                                                        <ul class="nav nav-icons" role="tablist">
                                                            ...
                                                            <li>
                                                                <a href="#meter-pembanding" role="tab"
                                                                   data-toggle="tab">
                                                            ...
                                                            <li class="">
                                                                <a href="#pemakaian-sendiri" role="tab"
                                                                   data-toggle="tab">
                                                    ...
                                                    <div class="tab-content">
                                                        <div class="tab-pane active" id="meter-utama">
                                                            <div class="card">
                                                                <div class="header">
                                                                    ...
                                                                    <p class="category">TRAFO
                                                                        GI {{$trafo_gi->nama_trafo_gi}}</p>
                                                                </div>
                                                                <div class="content">
                                                                </div>
                                                            </div>
                                                            <form action="{{route('input_datamaster.store')}}"
                                                                ...
                                                                <input type="hidden" name="form_trafogi"
                                                                       value="{{$trafo_gi->id}}">
                                                                <input type="hidden" name="form_utama"
                                                                       value="{{$trafo_gi->id}}">
                                                                {{ csrf_field() }}
                                                                                        ...
                                                                                        <div class="col-md-12">
                                                                                            <div class="form-group">
                                                                                                ...
                                                                                                <input type="text"
                                                                                                       ...
                                                                                                       value="{{$decoded['utama']['KWH']['nomorseri']}}">
                                                                                            </div>
                                                                                        </div>
                                                                                    </div>
                                                                                        ...
                                                                                        <div class="col-md-12">
                                                                                            <div class="form-group">
                                                                                                ...
                                                                                                <input type="text"
                                                                                                       ...
                                                                                                       value="{{$decoded['utama']['KWH']['konstanta']}}">
                                                                                            </div>
                                                                                        </div>
                                                                                    </div>
                                                                                        ...
                                                                                        <div class="col-md-12">
                                                                                            <div class="form-group">
                                                                                                ...
                                                                                                <input type="text"
                                                                                                       name="teganganarus"
                                                                                                       class="form-control"
                                                                                                       placeholder="Tegangan Arus"
                                                                                                       value="{{$decoded['utama']['KWH']['teganganarus']}}">
                                                                                            </div>
                                                                                        </div>
                                                                                    </div>
                                                                                        ...
                                                                                        <div class="col-md-12">
                                                                                            <div class="form-group">
                                                                                                ...
                                                                                                <input type="text"
                                                                                                       ...
                                                                                                       class="form-control"
                                                                                                       placeholder="Ratio"
                                                                                                       value="{{$decoded['utama']['TA']['ratioct']}}">
                                                                                            </div>
                                                                                        </div>
                                                                                    </div>
                                                                                        ...
                                                                                        <div class="col-md-12">
                                                                                            <div class="form-group">
                                                                                                ...
                                                                                                <input type="text"
                                                                                                       name="burdenct"
                                                                                                       class="form-control"
                                                                                                       placeholder="Burden (VA)"
                                                                                                       value="{{$decoded['utama']['TA']['burdenct']}}">
                                                                                            </div>
                                                                                        </div>
                                                                                    </div>
                                                                                        ...
                                                                                        <div class="col-md-12">
                                                                                            <div class="form-group">
                                                                                                ...
                                                                                                <input type="text"
                                                                                                       ...
                                                                                                       class="form-control"
                                                                                                       placeholder="Ratio"
                                                                                                       value="{{$decoded['utama']['TT']['ratiopt']}}">
                                                                                            </div>
                                                                                        </div>
                                                                                    </div>
                                                                                        ...
                                                                                        <div class="col-md-12">
                                                                                            <div class="form-group">
                                                                                                ...
                                                                                                <input type="text"
                                                                                                       ...
                                                                                                       class="form-control"
                                                                                                       placeholder="Burden (VA)"
                                                                                                       value="{{$decoded['utama']['TT']['burdenpt']}}">
                                                                                            </div>
                                                                                        </div>
                                                                                    </div>
                                                                                        ...
                                                                                        <div class="col-md-12">
                                                                                            <div class="form-group">
                                                                                                ...
                                                                                                <input type="number"
                                                                                                       name="faktorkali"
                                                                                                       class="form-control"
                                                                                                       placeholder="Faktor Kali"
                                                                                                       value="{{$decoded['utama']['FK']['faktorkali']}}">
                                                                                            </div>
                                                                                        </div>
                                                                                    </div>
                                                        ...
                                                        <div class="tab-pane" id="meter-pembanding">
                                                            ...
                                                            <form action="{{route('input_datamaster.store')}}"
                                                                ...
                                                                <input type="hidden" name="form_trafogi"
                                                                       value="{{$trafo_gi->id}}">
                                                                <input type="hidden" name="form_pembanding"
                                                                       value="{{$trafo_gi->id}}">
                                                                {{ csrf_field() }}
                                                                                        ...
                                                                                        <div class="col-md-12">
                                                                                            <div class="form-group">
                                                                                                ...
                                                                                                <input type="text"
                                                                                                       ...
                                                                                                       class="form-control"
                                                                                                       placeholder="Merk"
                                                                                                       value="{{$decoded['pembanding']['KWH']['merk']}}">
                                                                                            </div>
                                                                                        </div>
                                                                                    </div>
                                                                                        ...
                                                                                        <div class="col-md-12">
                                                                                            <div class="form-group">
                                                                                                ...
                                                                                                <input type="text"
                                                                                                       ...
                                                                                                       class="form-control"
                                                                                                       placeholder="Nomor Seri"
                                                                                                       value="{{$decoded['pembanding']['KWH']['nomorseri']}}">
                                                                                            </div>
                                                                                        </div>
                                                                                    </div>
                                                                                        ...
                                                                                        <div class="col-md-12">
                                                                                            <div class="form-group">
                                                                                                ...
                                                                                                <input type="text"
                                                                                                       ...
                                                                                                       class="form-control"
                                                                                                       placeholder="Konstanta"
                                                                                                       value="{{$decoded['pembanding']['KWH']['konstanta']}}">
                                                                                            </div>
                                                                                        </div>
                                                                                    </div>
                                                                                        ...
                                                                                        <div class="col-md-12">
                                                                                            <div class="form-group">
                                                                                                ...
                                                                                                <input type="text"
                                                                                                       ...
                                                                                                       class="form-control"
                                                                                                       placeholder="Tegangan Arus"
                                                                                                       value="{{$decoded['pembanding']['KWH']['teganganarus']}}">
                                                                                            </div>
                                                                                        </div>
                                                                                    </div>
                                                                                        ...
                                                                                        <div class="col-md-12">
                                                                                            <div class="form-group">
                                                                                                ...
                                                                                                <input type="text"
                                                                                                       ...
                                                                                                       class="form-control"
                                                                                                       placeholder="Ratio"
                                                                                                       value="{{$decoded['pembanding']['TA']['ratioct']}}">
                                                                                            </div>
                                                                                        </div>
                                                                                    </div>
                                                                                        ...
                                                                                        <div class="col-md-12">
                                                                                            <div class="form-group">
                                                                                                ...
                                                                                                <input type="text"
                                                                                                       ...
                                                                                                       class="form-control"
                                                                                                       placeholder="Burden (VA)"
                                                                                                       value="{{$decoded['pembanding']['TA']['burdenct']}}">
                                                                                            </div>
                                                                                        </div>
                                                                                    </div>
                                                                                        ...
                                                                                        <div class="col-md-12">
                                                                                            <div class="form-group">
                                                                                                ...
                                                                                                <input type="text"
                                                                                                       ...
                                                                                                       class="form-control"
                                                                                                       placeholder="Ratio"
                                                                                                       value="{{$decoded['pembanding']['TT']['ratiopt']}}">
                                                                                            </div>
                                                                                        </div>
                                                                                    </div>
                                                                                        ...
                                                                                        <div class="col-md-12">
                                                                                            <div class="form-group">
                                                                                                ...
                                                                                                <input type="text"
                                                                                                       ...
                                                                                                       class="form-control"
                                                                                                       placeholder="Burden (VA)"
                                                                                                       value="{{$decoded['pembanding']['TT']['burdenpt']}}">
                                                                                            </div>
                                                                                        </div>
                                                                                    </div>
                                                                                        ...
                                                                                        <div class="col-md-12">
                                                                                            <div class="form-group">
                                                                                                ...
                                                                                                <input type="number"
                                                                                                       ...
                                                                                                       class="form-control"
                                                                                                       placeholder="Faktor Kali"
                                                                                                       value="{{$decoded['pembanding']['FK']['faktorkali']}}">
                                                                                            </div>
                                                                                        </div>
                                                                                    </div>
                                                        ...
                                                        <div class="tab-pane" id="pemakaian-sendiri">
                                                            ...
                                                            <form action="{{route('input_datamaster.store')}}"
                                                                ...
                                                                <input type="hidden" name="form_trafogi"
                                                                       value="{{$trafo_gi->id}}">
                                                                <input type="hidden" name="form_ps"
                                                                       value="{{$trafo_gi->id}}">
                                                                {{ csrf_field() }}
                                                                <div class="content" id="kwhmeter">
                                                                    <div class="row">
                                                                                        ...
                                                                                        <div class="col-md-12">
                                                                                            <div class="form-group">
                                                                                                ...
                                                                                                <input type="text"
                                                                                                       ...
                                                                                                       class="form-control"
                                                                                                       placeholder="Nomor Seri"
                                                                                                       value="{{$decoded['ps']['KWH']['nomorseri']}}">
                                                                                            </div>
                                                                                        </div>
                                                                                    </div>
                                                                                        ...
                                                                                        <div class="col-md-12">
                                                                                            <div class="form-group">
                                                                                                ...
                                                                                                <input type="text"
                                                                                                       ...
                                                                                                       class="form-control"
                                                                                                       placeholder="Konstanta"
                                                                                                       value="{{$decoded['ps']['KWH']['konstanta']}}">
                                                                                            </div>
                                                                                        </div>
                                                                                    </div>
                                                                                        ...
                                                                                        <div class="col-md-12">
                                                                                            <div class="form-group">
                                                                                                ...
                                                                                                <input type="text"
                                                                                                       ...
                                                                                                       class="form-control"
                                                                                                       placeholder="Tegangan Arus"
                                                                                                       value="{{$decoded['ps']['KWH']['teganganarus']}}">
                                                                                            </div>
                                                                                        </div>
                                                                                    </div>
                                                                                        ...
                                                                                        <div class="col-md-12">
                                                                                            <div class="form-group">
                                                                                                ...
                                                                                                <input type="number"
                                                                                                       ...
                                                                                                       class="form-control"
                                                                                                       placeholder="Faktor Kali"
                                                                                                       value="{{$decoded['ps']['FK']['faktorkali']}}">
                                                                                            </div>
                                                                                        </div>
                                                                                    </div>
                                                ...
                                                {{--<div class="tab-content">--}}
                                                    <div class="tab-pane active" id="meter-utama">
                                                        <form action="{{route('input_datamaster.store')}}"
                                                            ...
                                                            <input type="hidden" name="idgardu"
                                                                   value={{$gardu->id}}>
                                                            <input type="hidden" name="form_gardu"
                                                                   value={{$gardu->id}}>
                                                            {{ csrf_field() }}
                                                                                        ...
                                                                                        <div class="form-group">
                                                                                            ...
                                                                                            @if($meter)
                                                                                                <input type="text"
                                                                                                       ...
                                                                                                       class="form-control"
                                                                                                       placeholder="Merk"
                                                                                                       value="{{$decoded['meter']['KWH']['merk']}}">
                                                                                            @else
                                                                                                <input type="text"
                                                                                                       name="merk"
                                                                                                       class="form-control"
                                                                                                       placeholder="Merk"
                                                                                                       value="{{$decoded['KWH']['merk']}}">
                                                                                            @endif
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
                                                                                        ...
                                                                                        <div class="form-group">
                                                                                            ...
                                                                                            @if($meter)
                                                                                                <input type="text"
                                                                                                       ...
                                                                                                       class="form-control"
                                                                                                       placeholder="Nomor Seri"
                                                                                                       value="{{$decoded['meter']['KWH']['nomorseri']}}">
                                                                                            @else
                                                                                                <input type="text"
                                                                                                       name="noseri"
                                                                                                       class="form-control"
                                                                                                       placeholder="Nomor Seri"
                                                                                                       value="{{$decoded['KWH']['nomorseri']}}">
                                                                                            @endif
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
                                                                                        ...
                                                                                        <div class="form-group">
                                                                                            ...
                                                                                            @if($meter)
                                                                                                <input type="text"
                                                                                                       ...
                                                                                                       class="form-control"
                                                                                                       placeholder="Konstanta"
                                                                                                       value="{{$decoded['meter']['KWH']['konstanta']}}">
                                                                                            @else
                                                                                                <input type="text"
                                                                                                       name="konstanta"
                                                                                                       class="form-control"
                                                                                                       placeholder="Konstanta"
                                                                                                       value="{{$decoded['KWH']['konstanta']}}">
                                                                                            @endif
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
                                                                                        ...
                                                                                        <div class="form-group">
                                                                                            ...
                                                                                            @if($meter)
                                                                                                <input type="text"
                                                                                                       ...
                                                                                                       class="form-control"
                                                                                                       placeholder="Tegangan Arus"
                                                                                                       value="{{$decoded['meter']['KWH']['teganganarus']}}">
                                                                                            @else
                                                                                                <input type="text"
                                                                                                       name="teganganarus"
                                                                                                       class="form-control"
                                                                                                       placeholder="Tegangan Arus"
                                                                                                       value="{{$decoded['KWH']['teganganarus']}}">
                                                                                            @endif
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
                                                                                        ...
                                                                                        <div class="form-group">
                                                                                            ...
                                                                                            @if($meter)
                                                                                                <input type="text"
                                                                                                       ...
                                                                                                       class="form-control"
                                                                                                       placeholder="Ratio"
                                                                                                       value="{{$decoded['meter']['TA']['ratioct']}}">
                                                                                            @else
                                                                                                <input type="text"
                                                                                                       name="ratioct"
                                                                                                       class="form-control"
                                                                                                       placeholder="Ratio"
                                                                                                       value="{{$decoded['TA']['ratioct']}}">
                                                                                            @endif
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
                                                                                        ...
                                                                                        <div class="form-group">
                                                                                            ...
                                                                                            @if($meter)
                                                                                                <input type="text"
                                                                                                       ...
                                                                                                       class="form-control"
                                                                                                       placeholder="Burden (VA)"
                                                                                                       value="{{$decoded['meter']['TA']['burdenct']}}">
                                                                                            @else
                                                                                                <input type="text"
                                                                                                       name="burdenct"
                                                                                                       class="form-control"
                                                                                                       placeholder="Burden (VA)"
                                                                                                       value="{{$decoded['TA']['burdenct']}}">
                                                                                            @endif
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
                                                                                        ...
                                                                                        <div class="form-group">
                                                                                            ...
                                                                                            @if($meter)
                                                                                                <input type="text"
                                                                                                       ...
                                                                                                       class="form-control"
                                                                                                       placeholder="Ratio"
                                                                                                       value="{{$decoded['meter']['TT']['ratiopt']}}">
                                                                                            @else
                                                                                                <input type="text"
                                                                                                       name="ratiopt"
                                                                                                       class="form-control"
                                                                                                       placeholder="Ratio"
                                                                                                       value="{{$decoded['TT']['ratiopt']}}">
                                                                                            @endif
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
                                                                                        ...
                                                                                        <div class="form-group">
                                                                                            ...
                                                                                            @if($meter)
                                                                                                <input type="text"
                                                                                                       ...
                                                                                                       class="form-control"
                                                                                                       placeholder="Burden (VA)"
                                                                                                       value="{{$decoded['meter']['TT']['burdenpt']}}">
                                                                                            @else
                                                                                                <input type="text"
                                                                                                       name="burdenpt"
                                                                                                       class="form-control"
                                                                                                       placeholder="Burden (VA)"
                                                                                                       value="{{$decoded['TT']['burdenpt']}}">
                                                                                            @endif
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
                                                                                        ...
                                                                                        <div class="form-group">
                                                                                            ...
                                                                                            @if($meter)
                                                                                                <input type="number"
                                                                                                       ...
                                                                                                       class="form-control"
                                                                                                       placeholder="Faktor Kali"
                                                                                                       value="{{$decoded['meter']['FK']['faktorkali']}}">
                                                                                            @else
                                                                                                <input type="number"
                                                                                                       name="faktorkali"
                                                                                                       class="form-control"
                                                                                                       placeholder="Faktor Kali"
                                                                                                       value="{{$decoded['FK']['faktorkali']}}">
                                                                                            @endif
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
                                                        ...
                                                        <form action="{{route('input_datamaster.store')}}"
                                                            ...
                                                            @if($id_gi)
                                                                ...
                                                                <input type="hidden" name="form_gi"
                                                                       value={{$gi->id}}>
                                                            @elseif($id_penyulang)
                                                                <input type="hidden" name="idpenyulang"
                                                                       value={{$penyulang->id}}>
                                                                <input type="hidden" name="form_penyulang"
                                                                       value={{$penyulang->id}}>
                                                                <input type="hidden" name="form_ujung"
                                                                       value={{$penyulang->id}}>
                                                            @elseif($id_gardu)
                                                                <input type="hidden" name="idgardu"
                                                                       value={{$gardu->id}}>
                                                                                ...
                                                                                @if($key->tipe_gardu == 0)
                                                                                    ...
                                                                                    <tr>
                                                                                        ...
                                                                                        <td class="td-actions text-right">
                                                                                            <a href="{{route('area.lihat_gardu', [$id_org, $key->id])}}"
                                                                                               rel="tooltip" title=""
                                                            ...
                                                            <div class="col-md-12">
                                                                <div class="card">
                                                                    <form action="{{route('input_datamaster.store')}}"
                                                                        ...
                                                                        <input type="hidden" name="idpenyulang"
                                                                               value={{$penyulang->id}}>
                                                                        <input type="hidden" name="idrayon"
                                                                               value={{$rayon->id_organisasi}}>
                                                                        <input type="hidden" name="id_org"
                                                                               value={{$id_org}}>
                                                                        <input type="hidden" name="tipe_" value=0>
                                                                        {{ csrf_field() }}
                                                                        <div class="header">Tambah Gardu Distribusi
                                                                        </div>
                                                                        <div class="content">


                                                                            <div class="form-group">
                                                                                <label class="control-label">Nama Gardu
                                                                                    Distribusi
                                                                                    <star>*</star>
                                                                                </label>
                                                                                <input class="form-control"
                                                                                       name="tambahnamagardu"
                                                                ...
                                                                <div class="card">
                                                                    <form action="{{route('input_datamaster.store')}}"
                                                                        ...
                                                                        <div class="content">
                                                                            ...
                                                                            <div class="form-group">
                                                                                <label class="control-label">Nama PCT
                                                                                    <star>*</star>
                                                                                </label>
                                                                                <input class="form-control"
                                                                                       name="tambahnamagardu"
                                                                            ...
                                                                            <div class="form-group">
                                                                                <label class="control-label">Alamat PCT
                                                                                    <star>*</star>
                                                                                </label>
                                                                                <input class="form-control"
                                                                                       name="tambahalamatgardu"
                                                                            ...
                                                                            @foreach($data as $key)
                                                                                @if($key->tipe_gardu == 2)
                                                                                    ...
                                                                                    <tr>
                                                                                        ...
                                                                                        <td>{{$rayon->nama_organisasi}}</td>
                                                                                        <td class="td-actions text-right">
                                                                                            <a href="{{route('area.lihat_ptm', [$id_org, $key->id])}}"
                                                                                               rel="tooltip" title=""
                                                                                               class="btn btn-info btn-fill"
                                                                                               data-original-title="View Datamaster">
                                                                                                <i class="fa fa-user"></i>
                                                                                ...
                                                                                <tr>
                                                                                    ...
                                                                                    <td class="td-actions text-right">
                                                                                        ...
                                                                                        @elseif($id_trafo_gi)
                                                                                            ...
                                                                                            <a href="{{route('area.lihat_penyulang', [$id_org, $key->id])}}"
                                                                                               rel="tooltip" title=""
                                                                                               class="btn btn-info btn-fill"
                                                                                               data-original-title="View Datamaster">
                                                                                                <i class="fa fa-user"></i>
                                                                ...
                                                                <div class="card">
                                                                    @if($id_gi)
                                                                        <form action="{{route('input_datamaster.store')}}"
                                                                            ...
                                                                            <input type="hidden" name="_method"
                                                                                   value="POST">
                                                                            <input type="hidden" name="trafogi"
                                                                                   value="{{$id_gi}}">
                                                                            <input type="hidden" name="idgardu"
                                                                                   value={{$gi->id}}>
                                                                            <input type="hidden" name="idrayon"
                                                                    ...
                                                                    @elseif($id_trafo_gi)
                                                                        <form action="{{route('input_datamaster.store')}}"
                                                                            ...
                                                                            <input type="hidden" name="_method"
                                                                                   value="POST">
                                                                            <input type="hidden" name="penyulang"
                                                                                   value="{{$id_trafo_gi}}">
                                                                            <input type="hidden" name="idtrafo_gi"
                                                                                   value={{$trafo_gi->id}}>
                                                                            <input type="hidden" name="idrayon"
                                                                        ...
                                                                        <div class="card">
                                                                            <form action="{{route('input_datamaster.store')}}"
                                                                                ...
                                                                                <input type="hidden" name="rayon"
                                                                                       value={{$rayon->nama_organisasi}}>
                                                                                <input type="hidden" name="gardu"
                                                                                       value={{$gardu->id_penyulang}}>
                                                                                <input type="hidden" name="form_gardu"
                                                                                       value="{{$gardu->id}}">
                                                                                <input type="hidden"
                                                                                       name="form_editExim"
                                                                                    ...
                                                                                    <div class="form-group"
                                                                                        ...
                                                                                        <div class="row">
                                                                                            <div class="col-md-6">
                                                                                                <div class="btn-group bootstrap-select">
                                                                                                    <div class="btn-group bootstrap-select">
                                                                                                        <select name="selectpenyulangsingle"
                                                                                                                class="selectpicker"
                                                                                                                data-title="Single Select"
                                                                                                                required="required"
                                                                                                                data-style="btn-default btn-block"
                                                                        ...
                                                                        @if($id_gi)
                                                                            <form action="{{route('input_datamaster.store')}}"
                                                                                ...
                                                                                <input type="hidden" name="id_org"
                                                                                       value={{$id_org}}>
                                                                                {{ csrf_field() }}
                                                                                <div class="header">Tambah Trafo GI
                                                                                </div>
                                                                                <div class="content">
                                                                        ...
                                                                        @elseif($id_trafo_gi)
                                                                            <form action="{{route('input_datamaster.store')}}"
                                                                                ...
                                                                                <input type="hidden" name="id_org"
                                                                                       value={{$id_org}}>
                                                                                {{ csrf_field() }}
                                                                                <div class="header">Tambah Penyulang
                                                                                </div>
                                                                                <div class="content">
