        ...
        <div class="border-kotak">
            ...
            <tbody>
                ...
                @for($i=0;$i<count($data_gi[$j]['data_gi']);$i++)
                    ...
                    <td>{{$data_gi[$j]['data_gi'][$i]['lwbp1']}}</td>
                    <td>{{$data_gi[$j]['data_gi'][$i]['lwbp2']}}</td>
                    <td>{{$data_gi[$j]['data_gi'][$i]['wbp']}}</td>
                    <td>{{$data_gi[$j]['data_gi'][$i]['total_kwh']}}</td>
                    <td>{{$data_gi[$j]['data_gi'][$i]['Kvarh']}}</td>
                    <td>{{$data_gi[$j]['data_gi'][$i]['KW']}}</td>
                    <td>{{$data_gi[$j]['data_gi'][$i]['ujung']}}</td>
                    <td>{{$data_gi[$j]['data_gi'][$i]['KWH_lalu']}}</td>
                    <td>{{$data_gi[$j]['data_gi'][$i]['KWH']}}</td>
                    <td>{{$data_gi[$j]['data_gi'][$i]['persen']}}</td>
                    <td>{{$data_gi[$j]['data_gi'][$i]['jual']}}</td>
                    <td>{{$data_gi[$j]['data_gi'][$i]['susut']}}</td>
                    <td>{{$data_gi[$j]['data_gi'][$i]['losses']}}</td>
                ...
                <tr>
                    ...
                    <td class="text-right"><b>{{$data_gi[$j]['total_jumlah']['lwbp1']}}</b></td>
                    <td class="text-right"><b>{{$data_gi[$j]['total_jumlah']['lwbp2']}}</b></td>
                    <td class="text-right"><b>{{$data_gi[$j]['total_jumlah']['wbp']}}</b></td>
                    <td class="text-right"><b>{{$data_gi[$j]['total_jumlah']['total_kwh']}}</b></td>
                    <td class="text-right"><b>{{$data_gi[$j]['total_jumlah']['Kvarh']}}</b></td>
                    <td class="text-right"><b>{{$data_gi[$j]['total_jumlah']['KW']}}</b></td>
                    <td class="text-center"><b></b></td>
                    <td class="text-right"><b>{{$data_gi[$j]['total_jumlah']['KWH_lalu']}}</b></td>
                    <td class="text-right"><b>{{$data_gi[$j]['total_jumlah']['KWH']}}</b></td>
                    <td class="text-right"><b>{{$data_gi[$j]['total_jumlah']['persen']}}</b></td>
                    <td class="text-right"><b>{{$data_gi[$j]['total_jumlah']['jual']}}</b></td>
                    <td class="text-right"><b>{{$data_gi[$j]['total_jumlah']['susut']}}</b></td>
                    <td class="text-right"><b>{{$data_gi[$j]['total_jumlah']['losses']}}</b></td>
                    <td><b></b></td>
                </tr>
            @endfor
            @endif
