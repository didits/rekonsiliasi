...
<table>
    ...
    <div class="border-kotak">
        ...
        <tr class="text-right">
            ...
            <td id="tebal-atas">{{number_format(json_decode($data_master[$tr]['data'],true)['hasil_pengolahan']['utama']['visual']['total_pemakaian_kwh_visual'], 2)}}</td>
            <td id="tebal-atas">{{number_format(json_decode($data_master[$tr]['data'],true)['hasil_pengolahan']['utama']['download']['total_pemakaian_kwh_download'], 2)}}</td>
            <td id="tebal-atas">{{number_format(json_decode($data_master[$tr]['data'],true)['hasil_pengolahan']['pembanding']['visual']['total_pemakaian_kwh_visual'], 2)}}</td>
            <td id="tebal-atas">{{number_format(json_decode($data_master[$tr]['data'],true)['hasil_pengolahan']['pembanding']['download']['total_pemakaian_kwh_download'], 2)}}</td>
            @if($visual == 1)
                <td id="tebal-atas">{{number_format(json_decode($data_master[$tr]['data'],true)['hasil_pengolahan']['ps']['visual']['total_pemakaian_kwh_visual'], 2)}}</td>
            @elseif($visual == 0)
                <td id="tebal-atas">{{number_format(json_decode($data_master[$tr]['data'],true)['hasil_pengolahan']['ps']['download']['total_pemakaian_kwh_download'], 2)}}</td>
            @endif
            <td id="tebal-atas">{{$sum[$tr]}}</td>
            <td id="tebal-atas">-</td>
            @for ($j=0; $j < count($dt_trafo[$tr]); $j++)
                <td id="tebal-atas">{{number_format(json_decode($dt_trafo[$tr][$j]['data'],true)['hasil_pengolahan']['visual']['total_pemakaian_kwh_visual'], 2)}}</td>
                <td id="tebal-atas">{{number_format(json_decode($dt_trafo[$tr][$j]['data'],true)['hasil_pengolahan']['download']['total_pemakaian_kwh_download'], 2)}}</td>
            @endfor
            <td id="tebal-atas"></td>
        </tr>
    </div>
